...
if __name__ == "__main__":
    ...
    while True:
        angle = randrange(0, 360); dist = randrange(1, 50)
        ...
        if sqrt((t1X - t2X) ** 2 + (t1Y - t2Y) ** 2) <= 30:
            t1.turtlesize(randrange(1, 10))
            t2.turtlesize(randrange(1, 10))
        if sqrt((t1X - t3X) ** 2 + (t1Y - t3Y) ** 2) <= 30:
            t1.turtlesize(randrange(1, 10))
            t3.turtlesize(randrange(1, 10))
        if sqrt((t2X - t3X) ** 2 + (t2Y - t3Y) ** 2) <= 30:
            t2.turtlesize(randrange(1, 10))
            t3.turtlesize(randrange(1, 10))
